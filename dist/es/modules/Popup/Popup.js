...
import { eventStack, childrenUtils, customPropTypes, getElementType, getUnhandledProps, isBrowser, SUI, useKeyOnly, useKeyOrValueAndKey, isRefObject } from '../../lib';
...
function (_Component) {
  ...
  function Popup() {
    ...
    _defineProperty(_assertThisInitialized(_this), "computePopupStyle", function (positions) {
      var style = {
        position: 'absolute'
      };
    ...
    _defineProperty(_assertThisInitialized(_this), "isStyleInViewport", function (style) {
      var _window2 = window,
    ...
    _defineProperty(_assertThisInitialized(_this), "setPopupStyle", function () {
    ...
    _defineProperty(_assertThisInitialized(_this), "handlePopupRef", function (popupRef) {
      _this.popupCoords = popupRef ? popupRef.getBoundingClientRect() : null;

      _this.setPopupStyle();
    });

    _defineProperty(_assertThisInitialized(_this), "handleTriggerRef", function (triggerRef) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getContext", function () {
      ...
      var contextFromProp = isRefObject(context) ? context.current : context;
  ...
  _createClass(Popup, [{
    ...
    value: function render() {
      ...
      var popupJSX = React.createElement(Ref, {
