...
function (_Component) {
  ...
  function Modal() {
    ...
    _defineProperty(_assertThisInitialized(_this), "mouseDownEvent", null);
    ...
    _defineProperty(_assertThisInitialized(_this), "handleDocumentMouseUp", function (e) {
      var closeOnDimmerClick = _this.props.closeOnDimmerClick;
      if (!closeOnDimmerClick || doesNodeContainClick(_this.ref.current, _this.mouseDownEvent) || doesNodeContainClick(_this.ref.current, e)) return;
