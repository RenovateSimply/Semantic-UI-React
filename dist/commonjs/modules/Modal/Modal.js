...
function (_Component) {
  ...
  function Modal() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "mouseDownEvent", null);
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "handleDocumentMouseUp", function (e) {
      var closeOnDimmerClick = _this.props.closeOnDimmerClick;
      if (!closeOnDimmerClick || (0, _lib.doesNodeContainClick)(_this.ref.current, _this.mouseDownEvent) || (0, _lib.doesNodeContainClick)(_this.ref.current, e)) return;
      (0, _invoke2["default"])(_this.props, 'onClose', e, _this.props);
